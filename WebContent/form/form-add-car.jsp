...
<c:if test="${CAR == null}">
	<form
		action="${pageContext.request.contextPath}/CarServlet?command=ADD"
		method="post" id="carForm">
</c:if>
<c:if test="${CAR != null}">
	<form
		action="${pageContext.request.contextPath}/CarServlet?command=UPDATE"
		method="post" id="carForm">
</c:if>
<div class="form-group row">
	...
	<div class="col-md-9">
		<c:if test="${CAR == null}">
		<input type="text" placeholder="Enter Car license plate"
			class="form-control" name="licensePlate" value="${CAR.licensePlate}">
		</c:if>
		<c:if test="${CAR != null}">
			<input type="text" placeholder="Enter Car license plate"
			class="form-control" name="licensePlate" readonly value="${CAR.licensePlate}">
		</c:if>
	</div>
</div>
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" placeholder="Enter Car type" class="form-control"
			name="carType" value="${CAR.carColor}">
	</div>
</div>
<div class="form-group row">
	...
	<div class="col-md-9">
		<input type="text" class="form-control" placeholder="Enter car color"
			name="carColor" value="${CAR.carType}">
	</div>
</div>
<div class="form-group row">
